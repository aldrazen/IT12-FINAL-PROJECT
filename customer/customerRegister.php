        ...
        <div class="row mt-2">
          <div class="col-lg-6">
            <div class="form-outline">
              ...
              <input type="number" class="form-control rounded-4 py-2 bg-transparent border-4" name="Phonenumber"
          ...
          <div class="col-lg-6">
            <div class="form-outline">
              ...
              <input type="text" class="form-control rounded-4 py-2 bg-transparent border-4" name="Address" id="Address"
                required>
            </div>
          </div>
        </div>
